...
/******************************************************************************
  ...
  To compile adapt the code below wo match your filenames:  
	mpicc -o image_mpi_115 image_mpi_115.c -lglut -lGL -lm -lcrypt

	mpirun -n 5  -quiet ./image_mpi_115 
...
void detect_edges(unsigned char *in, unsigned char *out) {
  ...
  for(i=0;i<n_pixels;i++) {
	...
	int b, s, u, v; // the pixels adjacent to x,y used for the calculation
